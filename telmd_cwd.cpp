...
//  BSF added change to allow CO2 to vary based on annual data
...
//if(dm == 0) {cout << "entering stepmonth = " << dyr << endl;}
...
//if(dm == 0) {cout << "finished stepmonth"  << endl;}
//     cout << "dyr = " << dyr << endl;
      #ifdef DEBUGT
...
//cout << "diag = " << dyr << " " << tem.strteq << " " << tem.endeq << endl;
    if( dyr >= tem.strteq && 0 == tem.endeq )
    {
//cout << "entering testEquilibrium" << endl;
...
//cout << "leaving testEquilibrium" << endl;
...
//cout << "dyr = " << dyr << " " << de_startyear << " " << clm.startyr << endl;
...
//cout << "entering equilibrateTEM loop" << endl;
