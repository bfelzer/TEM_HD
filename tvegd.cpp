...
//  cout << "setting seed " << seed.allocc << " " << labile.carbon << " " << pdm << endl;
//  cin.get();
  }
  else
  {
...
/*  if(agstate == 1 && pdm == 274 && labile.carbon > 0) {
//     cout << "labile carbon  = " << labile.carbon << endl;
     seed.allocc += 3.0 * labile.carbon;
     seed.allocn = seed.allocc/cnseed[pdcmnt];
//  cout << "adding to seed " << seed.allocc << " " << labile.carbon << " " << pdm << endl;
//  cin.get();
   } */ 
...
//    cout << "fp, fd = " << fp << " " << vpr << " " << vpd << " " << fp <<  " " << frdl << " " << temp << " " << fozone << " " << fh2o << endl;
  
  veggpp = cmaxgcmo * frdl * fco2 * temp * fozone * fh2o;
// cout << "veggpp1 = " << veggpp << " " << cmaxgcmo << " " << frdl << " " << fco2 << " " << temp << " " << fozone << " " << fh2o << endl;
//  cout << "veggpp " << veggpp << " " << cmax << " " << cmaxgcmo << " " << frdl << " " << fco2 << " " << temp << " " << fozone << " " << fh2o << " " << lai << " " << parw << " " << pdayl << endl;
//  temdiagfile << "veggpp " << veggpp << " " << cmax << " " << cmaxgcmo << " " << frdl << " " << fco2 << " " << temp << " " << fozone << " " << fh2o << " " << lai << " " << parw << endl;
//  cout << "veggpp2 " << veggpp << " " << frdl << " " << frad << " " << lai << " " << parw << " " << pdayl << endl;
...
// cout << "setCI = " << pdcmnt << " " << pndays << " " << fp << " " << fd << " " << ca << " " <<  rhmicrobe << " " << pdayl << endl;
...
/*      if(labile.carbon > labile.nitrogen)
        {
        denitr = 0.5*(labile.nitrogen - ((1.0/cnprod)*labile.carbon));
        }
        else
        {
        denitr = 0.0;
        } */
//  BSF  Can't make this work - shutting off this potential component of denitrification
        denitr = 0.0;
//        cout << "denitr in tveg = " << denitr << " " << labile.nitrogen << " " << labile.carbon << " " << cnprod << endl;
//        cin.get();
      }
    }
    else
