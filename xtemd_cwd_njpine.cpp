...
************************************************************* */
  ...
  for( ichrt = 0; ichrt < telmnt[0].maxcohorts; ++ichrt )
  {
    if( istateflag > 0 )
    {
      ...
      cout << "readCohortState = " << ifstate << " " << ichrt << " " << CYCLE << endl;
...
//      cout << "par = " << pardat[dyr].mon[day] << " " << dyr << " " << day << " " << endl;
    }
    ...
    else // 0 == telmnt[0].lcluc.tlulcflag
    {
      for( ichrt = 0; ichrt < mxcohrtdat[0].total; ++ichrt )
      {
        gisend = lulcdat[0][ichrt].getdel( iflulc );
          ...
          cout << "land type = " << dyr << " " << lulcdat[0][ichrt].col << " " << lulcdat[0][ichrt].row << " "  << lulcdat[0][ichrt].potveg << " " << lulcdat[0][ichrt].currentveg << " " << lulcdat[0][ichrt].subtype << " " << " " << dyr << " " << ichrt <<  " " << lulcdat[0][ichrt].varname << endl;
        if( -1 == gisend )
        {
          flog1 << "Ran out of Land cover/land use data";
          flog1 << endl << endl;
