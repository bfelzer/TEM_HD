...
//cout << "resistances = " << r_aa << " " << r_as << " " << r_ss << " " << r_ac << " " << r_sc << " " << gc << endl;
...
//cout << "rnsoil = " << rnsoil << " " << nirr << " " << lwcor << " " << lai << " " << esoilmmmo << " " << snowcover << endl;
...
//    cout << "diag = " << pesoil << " " << beta << " " << vpdo << " "<< r_as << " " << rnsoil << " " << etimes << " " << nirr << " " << lwcor << " " << precip << endl;
