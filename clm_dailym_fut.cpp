...
//            cout << "clmdat leap =  " << clmdat.mon[i] << " " << i << " " << clmdat.col << " " << clmdat.row << " " << clmdat.year << " " << clmdat.month << " " << clmdat.day << endl;
         ...
         for(i=0; i < 365; i++)
         {
            gisend = clmdat.getdel(itfile,i);
            v[i][yr-startyr] = v[i][yr-startyr] + clmdat.mon[i];
if(clmdat.day == 3 && clmdat.month == 1 && clmdat.year == 2006)  { cout << "clmdat =  " << clmdat.mon[i] << " " << i << " " << clmdat.col << " " << clmdat.row << " " << clmdat.year << " " << clmdat.month << " " << clmdat.day << " " << yr-startyr << " " << v[i][yr-startyr] << endl;}
//            cout << "clmdat =  " << clmdat.mon[i] << " " << i << " " << clmdat.col << " " << clmdat.row << " " << clmdat.year << " " << clmdat.month << " " << clmdat.day << endl;
         }
...
//            cout << "clmdat =  " << clmdat.mon[i] << " " << i << " " << clmdat.col << " " << clmdat
//            .row << " " << clmdat.year << " " << clmdat.month << " " << clmdat.day << endl;
//                     }
//
//                              }
//
